...
\lstinputlisting[caption={Prepend}, label={lst:prepend}]{code/prepend.cpp}
...
Starting with C++20 there a new mechanism for defining type traits is added: concepts \todo{cite}.
